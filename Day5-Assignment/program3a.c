//Write a program to represent polynomial using linked list.implement polynomial addition operation.
...
struct node* add_poly(struct node* head1,struct node* head2)
{
    ...
    while(ptr1!=NULL && ptr2!=NULL)
    {
        ...
        {
            head3 = insert_list(head3,ptr1->coefficient + ptr2->coefficient,ptr1->exponent);
            ptr1 = ptr1->link;
            ptr2 = ptr2->link;
        }
        else if(ptr1->exponent > ptr2->exponent)
        {
            head3 = insert_list(head3,ptr1->coefficient,ptr1->exponent);
            ptr1 = ptr1->link;
        }
        else if(ptr1->exponent < ptr2->exponent)
        {
            head3 = insert_list(head3,ptr2->coefficient,ptr2->exponent);
            ptr2 = ptr2->link;
        }
    }
    while(ptr1!=NULL)
